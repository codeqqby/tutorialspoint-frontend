...
如需了解更多有关 tooltip 部件的细节，请查看 API 文档 [工具提示框部件（Tooltip Widget）](api-tooltip.html)。
...
<div class="ui-widget photo">
  ...
  <a href="http://en.wikipedia.org/wiki/File:Wien_Stefansdom_DSC02656.JPG">
    <img src="img/st-stephens.jpg" alt="圣史蒂芬大教堂（St. Stephen&apos;s Cathedral）" class="ui-corner-all">
  </a>
</div>
...
<div class="ui-widget photo">
  ...
  <a href="http://en.wikipedia.org/wiki/File:Tower_bridge_London_Twilight_-_November_2006.jpg">
    <img src="img/tower-bridge.jpg" alt="塔桥（Tower Bridge）" class="ui-corner-all">
  </a>
</div>
